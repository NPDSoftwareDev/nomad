...
if [ "$1" = 'nomad' ]; then
    ...
    cp /nomad/config/ssl/ca.cert /usr/local/share/ca-certificates/ca.cert && cp /nomad/config/ssl/consul.cert /usr/local/share/ca-certificates/consul.cert && cp /nomad/config/ssl/nomad.cert /usr/local/share/ca-certificates/nomad.cert && update-ca-certificates 
